  ...
  useEffect(() => {
    const fetchProfil = async () => {
      try {
        ...
        setDepartements(
          Array.isArray(departementsData) ? departementsData : [],
        );
    ...
    return (
      <div className="new-admin-layout">
        ...
        <main className="new-admin-main">
          <div className="profil-loading-shell">
            <div className="profil-loading-card">
              <div className="profil-loading-dots" aria-hidden="true">
                <span />
                <span />
                <span />
              </div>
              <div className="profil-loading-title">Chargement du profil…</div>
            </div>
          </div>
        </main>
      </div>
        ...
        <div className="new-admin-body">
          <header className="teacher-header">
            <div className="teacher-header-left">
              <p className="teacher-header-greeting">Paramètres</p>
              <h1 className="teacher-header-title">Mon <span>profil</span></h1>
          ...
          <div className="profil-grid">
            <div className="profil-card">
              ...
              >
                {[
                  ["Telephone", "Téléphone", "2X XXX XXX"],
                  ["Grade", "Grade", "Maître Assistant"],
                  ["Departement", "Département", "Informatique"],
                  ["Specialite", "Spécialité", "Algorithmique"],
                    ...
                    {field === "Departement" ? (
                      ...
                      >
                        ...
                        {editForm[field] &&
                          !departements.some(
                            (departement) =>
                              departement.name === editForm[field],
                          ) && (
                ...
                {editError && (
                  <div className="profil-form-error">{editError}</div>
                )}
                <button
                  type="submit"
                ...
                <div className="profil-form-group">
                  ...
                  <div className="profil-pw-wrapper">
                    <input
                      ...
                      onChange={(e) =>
                        setPwForm({ ...pwForm, ancienPassword: e.target.value })
                      }
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                      className="profil-btn-eye"
