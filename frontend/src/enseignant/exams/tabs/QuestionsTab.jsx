...
const QUESTION_TYPES = [
  ...
  { value: 'calcul', label: 'Calcul / Application' },
  { value: 'definition', label: 'Définition' },
  { value: 'schema', label: 'Schéma / Dessin' },
  { value: 'code', label: 'Code / Algorithme' },
  { value: 'completement', label: 'Compléter les blancs' },
];
